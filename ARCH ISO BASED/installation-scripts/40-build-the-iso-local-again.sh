...
echo
	...
	buildFolder=$HOME"/fifthgnu-build"
	outFolder=$HOME"/fifthgnu-Out"
...
echo
	...
	if pacman -Qi $package &> /dev/null; then
		...
		if pacman -Qi ame &> /dev/null; then

			echo "################################################################"
			echo "######### Installing with ame"
			echo "################################################################"
			ame -S --noconfirm $package
	...
	echo
	echo "Saving current archiso version to archiso.md"
	sudo sed -i "s/\(^archiso-version=\).*/\1$archisoVersion/" ../releng.md
	echo
	echo "Making mkarchiso verbose"
...
echo
	...
	echo
	mkdir $buildFolder
	cp -r ../releng $buildFolder/releng
...
echo
	...
	sudo mkarchiso -v -w $buildFolder -o $outFolder $buildFolder/releng/
